  ...
  return (
    <div className={cn("bg-[#f3eee4] min-h-screen p-3 md:p-6 lg:p-8 pt-24 md:pt-32 pb-8 space-y-8 selection:bg-[#ffb300] overflow-x-hidden", utoMedium.className)}>
        ...
        <div className="bg-[#f20028] rounded-[30px] md:rounded-[60px] lg:rounded-[80px] min-h-[70vh] md:min-h-[80vh] relative overflow-hidden flex items-center">
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-12 relative z-10 w-full py-16 md:py-24 text-center md:text-left">
            <div className="max-w-4xl">
              ...
              <h1 className={cn("text-black text-6xl md:text-[160px] leading-[0.85] md:leading-[0.8] uppercase tracking-normal md:tracking-tight mb-8", utoBlack.className)}>FEELS LIGHT</h1>
      ...
      <section className="py-16 md:py-24 px-4 max-w-5xl mx-auto">
        <h2 className={cn("text-4xl md:text-8xl uppercase text-black text-center mb-10 md:mb-16 leading-none", utoBlack.className)}>HOW WE&apos;RE DIFFERENT</h2>
      ...
      <section className="pb-8">
        <div className="bg-black rounded-[30px] md:rounded-[80px] py-20 md:py-32 px-6 text-center border-4 border-[#f3eee4] shadow-[10px_10px_0px_0px_#f20028] md:shadow-[20px_20px_0px_0px_#f20028]">
          <h2 className={cn("text-4xl md:text-9xl uppercase text-[#f3eee4] leading-[1.1] mb-8", utoBlack.className)}>Ready to <br /> transform?</h2>
