...
export default function AboutPage() {
  return (
    <div className={`bg-[#f20028] min-h-screen pt-40 pb-20 selection:bg-[#ffb300] selection:text-black ${utoMedium.className}`}>
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        {/* MELTED ILLUSTRATION - No background or border, just blended ink */}
