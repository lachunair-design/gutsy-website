...
// Fixed paths: assuming fonts are in the root /public/fonts/ folder
...
export function Footer() {
  return (
    <footer className="bg-[#121417] text-white pt-24 pb-12 rounded-t-[40px] relative">
      {/* 10% Off Tab - Styled from your screenshot */}
      ...
      <div className="mx-auto max-w-7xl px-8">
        ...
        <div className={`flex flex-col md:flex-row justify-between items-center pt-10 border-t border-white/5 text-[15px] tracking-[0.2em] ${utoMedium.className}`}>
          ...
          <div className="flex items-center gap-3 mt-6 md:mt-0 group cursor-pointer">
            <span className="opacity-60 group-hover:opacity-100 transition-opacity lowercase">@eatdirt.world</span>
