    ...
    <footer className="bg-[#121417] text-white pt-16 md:pt-24 pb-8 md:pb-12 rounded-t-[30px] md:rounded-t-[40px] relative overflow-hidden selection:bg-[#ffb300]">
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12 md:gap-24 mb-20 md:mb-32">
          ...
          {/* Navigation Links */}
          <div className="grid grid-cols-2 gap-x-12 md:gap-x-24 gap-y-8 w-full md:w-auto text-center md:text-left">
        ...
        {/* Footer Metadata */}
        <div className={cn("flex flex-col md:flex-row justify-between items-center pt-8 md:pt-10 border-t border-white/5 text-[13px] md:text-[15px] tracking-[0.2em] text-center md:text-left", utoMedium.className)}>
